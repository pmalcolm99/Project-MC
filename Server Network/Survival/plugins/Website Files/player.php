...
if (!isset($_GET['uuid'])) {
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card text-white bg-danger mb-3">
            <div class="card-header">Please provide a player UUID!</div>
        </div>
    </div>
    ';
    return;
...
<head>
	...
	<title>
		<?php echo Settings::$PAGE_TITLE;?> | Player Transactions
	</title>
</head>
	...
	<div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                <?php echo '<img src="https://crafatar.com/avatars/'.$uuid.'?size=100" alt="">'; ?>
            </div> 
            <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                <h2>Listing all transactions of: <strong><?php echo MojangAPI::getUsername($uuid); ?></strong></h2>
            </div>
        </div>
        <br>
		<div class="row">
			<?php
                ...
                for ($i = 0; $i < sizeof($results); $i++) {    
                    if($results[$i]['seller'] === $uuid || $results[$i]['buyer'] === $uuid) {
                        echo '
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
